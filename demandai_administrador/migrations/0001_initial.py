    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='images/demand_files')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demand_id', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='files', to='demandai_administrador.Demand')),
            ],
            options={
                'abstract': False,
            },
