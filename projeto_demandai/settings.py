"""
Django settings for projeto_demandai project.
...
SECRET_KEY = '=9i$a+n(q66jw1=8x%ira26fke7sa(tob8l_(ghk_r&km^eo+1'
...
ROOT_URLCONF = 'projeto_demandai.urls'
